...
static bool http_get(const char *url, long timeout, HttpBuffer *out)
{
    ...
    if (res != CURLE_OK) {
        if (player_logger)
            LOG_ERROR(player_logger, "HTTP GET failed: %s — %s", url, curl_easy_strerror(res));
        free(out->data);
        out->data = NULL;
        out->size = 0;
        return false;
...
{
    StatusParseCtx *ctx = data;
    PlayerStatus *st = ctx->status;
    const char *t = ctx->text;

    if (strcmp(el, "album") == 0) safe_strcpy(st->album, t, sizeof(st->album));
    else if (strcmp(el, "artist") == 0) safe_strcpy(st->artist, t, sizeof(st->artist));
    else if (strcmp(el, "title1") == 0) {
        safe_strcpy(st->title1, t, sizeof(st->title1));
        safe_strcpy(st->name, t, sizeof(st->name));
    }
    else if (strcmp(el, "title2") == 0) safe_strcpy(st->title2, t, sizeof(st->title2));
    else if (strcmp(el, "title3") == 0) safe_strcpy(st->title3, t, sizeof(st->title3));
    else if (strcmp(el, "state") == 0) safe_strcpy(st->state, t, sizeof(st->state));
    else if (strcmp(el, "volume") == 0) st->volume = safe_atoi(t);
    else if (strcmp(el, "service") == 0) safe_strcpy(st->service, t, sizeof(st->service));
    else if (strcmp(el, "inputId") == 0) safe_strcpy(st->input_id, t, sizeof(st->input_id));
    else if (strcmp(el, "canMovePlayback") == 0) st->can_move_playback = (strcmp(t, "true") == 0);
    else if (strcmp(el, "canSeek") == 0) st->can_seek = (safe_atoi(t) == 1);
    else if (strcmp(el, "cursor") == 0) st->cursor = safe_atoi(t);
    else if (strcmp(el, "db") == 0) st->db = safe_atof(t);
    else if (strcmp(el, "fn") == 0) safe_strcpy(st->fn, t, sizeof(st->fn));
    else if (strcmp(el, "image") == 0) safe_strcpy(st->image, t, sizeof(st->image));
    else if (strcmp(el, "indexing") == 0) st->indexing = safe_atoi(t);
    else if (strcmp(el, "mid") == 0) st->mid = safe_atoi(t);
    else if (strcmp(el, "mode") == 0) st->mode = safe_atoi(t);
    else if (strcmp(el, "mute") == 0) st->mute = (safe_atoi(t) == 1);
    else if (strcmp(el, "pid") == 0) st->pid = safe_atoi(t);
    else if (strcmp(el, "prid") == 0) st->prid = safe_atoi(t);
    else if (strcmp(el, "quality") == 0) safe_strcpy(st->quality, t, sizeof(st->quality));
    else if (strcmp(el, "repeat") == 0) st->repeat = safe_atoi(t);
    else if (strcmp(el, "serviceIcon") == 0) safe_strcpy(st->service_icon, t, sizeof(st->service_icon));
    else if (strcmp(el, "serviceName") == 0) safe_strcpy(st->service_name, t, sizeof(st->service_name));
    else if (strcmp(el, "shuffle") == 0) st->shuffle = (safe_atoi(t) == 1);
    else if (strcmp(el, "sid") == 0) st->sid = safe_atoi(t);
    else if (strcmp(el, "sleep") == 0) safe_strcpy(st->sleep_str, t, sizeof(st->sleep_str));
    else if (strcmp(el, "song") == 0) st->song = safe_atoi(t);
    else if (strcmp(el, "streamFormat") == 0) safe_strcpy(st->stream_format, t, sizeof(st->stream_format));
    else if (strcmp(el, "syncStat") == 0) st->sync_stat = safe_atoi(t);
    else if (strcmp(el, "totlen") == 0) st->totlen = safe_atoi(t);
    else if (strcmp(el, "secs") == 0) st->secs = safe_atoi(t);
    else if (strcmp(el, "albumid") == 0) safe_strcpy(st->albumid, t, sizeof(st->albumid));
    else if (strcmp(el, "artistid") == 0) safe_strcpy(st->artistid, t, sizeof(st->artistid));
    else if (strcmp(el, "composer") == 0) safe_strcpy(st->composer, t, sizeof(st->composer));
    else if (strcmp(el, "isFavourite") == 0) st->is_favourite = (strcmp(t, "1") == 0);
...
static void ensure_browse_capacity(BrowseParseCtx *ctx)
{
    if (ctx->count >= ctx->capacity) {
        ...
        ctx->items = realloc(ctx->items, new_cap * sizeof(PlayerSource));
...
static void browse_start(void *data, const char *el, const char **attr)
{
    ...
    /* Capture searchKey/nextKey from root element (may be <browse>, <items>, etc.) */
    if (strcmp(el, "item") != 0) {
        for (int i = 0; attr[i]; i += 2) {
    ...
    if (strcmp(el, "item") == 0) {
        ...
        for (int i = 0; attr[i]; i += 2) {
            ...
            if (strcmp(k, "text") == 0) safe_strcpy(s->text, v, sizeof(s->text));
            else if (strcmp(k, "text2") == 0) safe_strcpy(s->text2, v, sizeof(s->text2));
            else if (strcmp(k, "image") == 0) safe_strcpy(s->image, v, sizeof(s->image));
            else if (strcmp(k, "browseKey") == 0) safe_strcpy(s->browse_key, v, sizeof(s->browse_key));
            else if (strcmp(k, "playURL") == 0) safe_strcpy(s->play_url, v, sizeof(s->play_url));
            else if (strcmp(k, "actionURL") == 0) safe_strcpy(s->play_url, v, sizeof(s->play_url));
            else if (strcmp(k, "inputType") == 0) safe_strcpy(s->input_type, v, sizeof(s->input_type));
            else if (strcmp(k, "type") == 0) safe_strcpy(s->type, v, sizeof(s->type));
            else if (strcmp(k, "contextMenuKey") == 0) safe_strcpy(s->context_menu_key, v, sizeof(s->context_menu_key));
            else if (strcmp(k, "isFavourite") == 0) s->is_favourite = (strcmp(v, "true") == 0);
            else if (strcmp(k, "searchKey") == 0) safe_strcpy(s->search_key, v, sizeof(s->search_key));
        }
...
static void browse_end(void *data, const char *el) { (void)data; (void)el; }
                                      ...
                                      char *next_key, size_t nk_size)
{
    ...
    *count = ctx.count;
    if (search_key) safe_strcpy(search_key, ctx.search_key, sk_size);
    if (next_key) safe_strcpy(next_key, ctx.next_key, nk_size);
    return ctx.items;
}
    ...
    if (strcmp(el, "song") == 0) {
        ...
        for (int i = 0; attr[i]; i += 2) {
            if (strcmp(attr[i], "title") == 0)
                safe_strcpy(ctx->current.title, attr[i + 1], sizeof(ctx->current.title));
            else if (strcmp(attr[i], "art") == 0)
                safe_strcpy(ctx->current.artist, attr[i + 1], sizeof(ctx->current.artist));
            else if (strcmp(attr[i], "alb") == 0)
                safe_strcpy(ctx->current.album, attr[i + 1], sizeof(ctx->current.album));
        }
    }
}
...
static void playlist_end(void *data, const char *el)
{
    PlaylistParseCtx *ctx = data;
    if (ctx->in_song) {
        if (strcmp(el, "title") == 0) safe_strcpy(ctx->current.title, ctx->text, sizeof(ctx->current.title));
        else if (strcmp(el, "art") == 0) safe_strcpy(ctx->current.artist, ctx->text, sizeof(ctx->current.artist));
        else if (strcmp(el, "alb") == 0) safe_strcpy(ctx->current.album, ctx->text, sizeof(ctx->current.album));
        else if (strcmp(el, "song") == 0) {
            if (ctx->count >= ctx->capacity) {
                int new_cap = ctx->capacity ? ctx->capacity * 2 : 32;
                ctx->entries = realloc(ctx->entries, new_cap * sizeof(PlaylistEntry));
                ctx->capacity = new_cap;
            }
...
static void sync_end(void *data, const char *el) { (void)data; (void)el; }
...
static int parse_diagnostics(const char *html, KVPair *out, int max)
{
    ...
    const char *p = html;
    while (count < max) {
        const char *a_start = strstr(p, "\"ui-block-a\">");
        if (!a_start) break;
        a_start += strlen("\"ui-block-a\">");
        const char *a_end = strstr(a_start, "</div>");
        if (!a_end) break;

        const char *b_start = strstr(a_end, "\"ui-block-b\">");
        if (!b_start) break;
        b_start += strlen("\"ui-block-b\">");
        const char *b_end = strstr(b_start, "</div>");
        if (!b_end) break;

        char key[STR_MEDIUM], value[STR_LONG];
        size_t klen = int_min((int)(a_end - a_start), (int)sizeof(key) - 1);
        memcpy(key, a_start, klen);
        key[klen] = '\0';
        strip_html_tags(key);
        str_strip(key);
        ...
        size_t vlen = int_min((int)(b_end - b_start), (int)sizeof(value) - 1);
        memcpy(value, b_start, vlen);
        value[vlen] = '\0';
...
static void parse_upgrade_status(const char *html, char *out, size_t out_size)
{
    ...
    if (!gt) { safe_strcpy(out, "Unknown", out_size); return; }
    gt++;
    const char *end = strstr(gt, "</div>");
    if (!end) { safe_strcpy(out, "Unknown", out_size); return; }
    ...
    if (!out[0]) safe_strcpy(out, "Unknown", out_size);
}
...
{
    player_logger = logger_create("logs/cli.log", LOG_MAX_BYTES, LOG_BACKUP_COUNT);
}
...
BlusoundPlayer *player_create(const char *host, const char *name)
{
    ...
    snprintf(p->base_url, sizeof(p->base_url), "http://%s:%d", host, BLUOS_API_PORT);

    LOG_INFO(player_logger, "Initialized BlusoundPlayer: %s at %s", p->name, p->host_name);

    /* Fetch real name from SyncStatus */
    HttpBuffer buf = {0};
    ...
    /* Initialize sources with retries */
    for (int attempt = 0; attempt < SOURCE_INIT_MAX_RETRIES; attempt++) {
        ...
        free(sources);
        LOG_WARN(player_logger, "No sources for %s, attempt %d/%d",
                 p->name, attempt + 1, SOURCE_INIT_MAX_RETRIES);
...
{
    HttpBuffer buf = {0};
    if (!player_request(p, "/Status", NULL, &buf)) return false;
    ...
    LOG_INFO(player_logger, "Status: state=%s vol=%d song=%d", out->state, out->volume, out->song);
    return true;
}
...
{
    HttpBuffer buf = {0};
    if (!player_request(p, "/SyncStatus", NULL, &buf)) return false;
...
bool player_get_diagnostics(BlusoundPlayer *p, KVPair *out, int *count, int max)
{
    ...
    HttpBuffer buf = {0};
    if (!http_get(url, HTTP_TIMEOUT_HEALTH, &buf)) return false;
...
PlayerSource *player_browse(BlusoundPlayer *p, const char *key, int *count)
{
    ...
    HttpBuffer buf = {0};
    LOG_INFO(player_logger, "player_browse key='%s' params='%s'", key ? key : "(null)", params);
    if (!player_request(p, "/Browse", params[0] ? params : NULL, &buf)) {
        LOG_ERROR(player_logger, "player_browse request failed for key='%s'", key ? key : "(null)");
        *count = 0;
        return NULL;
    }
    LOG_INFO(player_logger, "player_browse response size=%zu data='%.2000s'", buf.size, buf.data ? buf.data : "(null)");
...
PlayerSource *player_browse_all(BlusoundPlayer *p, const char *key, int *total_count)
{
    PlayerSource *all = NULL;
    int all_count = 0, all_cap = 0;
    char current_key[STR_URL] = "";
    if (key) safe_strcpy(current_key, key, sizeof(current_key));
    ...
    while (1) {
        ...
        int page_count = 0;
        char next_key[STR_URL] = "";
        PlayerSource *page = parse_browse_xml(buf.data, &page_count, NULL, 0,
        ...
        if (page && page_count > 0) {
            if (all_count + page_count > all_cap) {
                ...
                all = realloc(all, all_cap * sizeof(PlayerSource));
            }
                            ...
                            const char *query, int *count)
{
    ...
    /* Parse results, filtering out skip categories and expanding Library */
    int raw_count = 0;
    char sk[STR_URL] = "";
    PlayerSource *raw = parse_browse_xml(buf.data, &raw_count, sk, sizeof(sk), NULL, 0);
    free(buf.data);

    PlayerSource *results = NULL;
    int res_count = 0, res_cap = 0;
    ...
    for (int i = 0; i < raw_count; i++) {
        ...
        if (strcmp(item->text, LIBRARY_CATEGORY_NAME) == 0 && item->browse_key[0]) {
            /* Expand library category */
            int lib_count = 0;
            PlayerSource *lib = player_browse(p, item->browse_key, &lib_count);
            if (lib && lib_count > 0) {
                if (res_count + lib_count > res_cap) {
                    res_cap = int_max(res_cap * 2, res_count + lib_count);
                    results = realloc(results, res_cap * sizeof(PlayerSource));
                }
                memcpy(results + res_count, lib, lib_count * sizeof(PlayerSource));
                res_count += lib_count;
                free(lib);
            }
            continue;
        ...
        if (res_count >= res_cap) {
            res_cap = res_cap ? res_cap * 2 : 32;
            results = realloc(results, res_cap * sizeof(PlayerSource));
        }
        results[res_count++] = *item;
    }
    free(raw);

    *count = res_count;
    LOG_INFO(player_logger, "Found %d search results", res_count);
    return results;
}
...
bool player_save_playlist(BlusoundPlayer *p, const char *name, char *msg, size_t msg_size)
{
    ...
    if (entries) {
        ...
        snprintf(msg, msg_size, "Saved '%s' (%.*s tracks)", name,
                 (int)(strchr(entries, '<') ? strchr(entries, '<') - entries : 0), entries);
    } else {
                                 ...
                                 bool *full_match, int *count)
{
    ...
    for (int i = 0; i < name_count; i++) {
        if (i > 0) strncat(cache_key, "/", sizeof(cache_key) - strlen(cache_key) - 1);
    ...
    for (int depth = 0; depth < name_count; depth++) {
        int items_count = 0;
        PlayerSource *items = player_browse(p, current_key[0] ? current_key : NULL, &items_count);
        ...
        for (int i = 0; i < items_count; i++) {
            LOG_INFO(player_logger, "browse_path depth=%d item=%d text='%s' browseKey='%s'",
                     depth, i, items[i].text, items[i].browse_key);
            if (str_contains_ci(items[i].text, names[depth]) && items[i].browse_key[0]) {
                safe_strcpy(current_key, items[i].browse_key, sizeof(current_key));
                found = true;
                LOG_INFO(player_logger, "browse_path matched '%s' at depth %d", names[depth], depth);
                break;
            }
        }
        free(items);
        if (!found) {
            LOG_INFO(player_logger, "browse_path: '%s' not found at depth %d (%d items checked)",
                                ...
                                char *msg, size_t msg_size)
{
    ...
    char params[STR_URL];
    snprintf(params, sizeof(params), "albumid=%s&service=%s", status->albumid, status->service);
    HttpBuffer buf = {0};
    bool ok = player_request(p, "/AddFavourite", params, &buf);
    free(buf.data);
    if (ok) snprintf(msg, msg_size, "Added to favourites: %s", status->album);
    else safe_strcpy(msg, "Error adding favourite", msg_size);
    return ok;
}
                                   ...
                                   char *msg, size_t msg_size)
{
    ...
    char cm_key[STR_URL];
    snprintf(cm_key, sizeof(cm_key), "%s:CM/%s-Album?albumid=%s&artist=%s&artistid=%s",
             status->service, status->service, status->albumid, artist_enc, status->artistid);
    ...
    /* Parse context menu items looking for "favourite" action */
    int items_count = 0;
    PlayerSource *items = parse_browse_xml(buf.data, &items_count, NULL, 0, NULL, 0);
    free(buf.data);

    for (int i = 0; i < items_count; i++) {
        if (str_contains_ci(items[i].text, "favourite") && items[i].play_url[0]) {
            char action_url[STR_URL * 2];
            snprintf(action_url, sizeof(action_url), "%s%s", p->base_url, items[i].play_url);
            HttpBuffer abuf = {0};
            bool ok = http_get(action_url, HTTP_TIMEOUT_PLAYER, &abuf);
            free(abuf.data);
            free(items);
            if (ok) snprintf(msg, msg_size, "Removed from favourites: %s", status->album);
            else safe_strcpy(msg, "Error removing favourite", msg_size);
            return ok;
        }
    }
    free(items);
                             ...
                             char *msg, size_t msg_size)
{
    ...
    for (int i = 0; i < items_count; i++) {
        if (!str_contains_ci(items[i].text, "favourite")) continue;

        /* Try actionURL first (stored in play_url from XML parsing) */
        ...
        /* Try browseKey */
        if (items[i].browse_key[0]) {
            char bparams[STR_URL];
            snprintf(bparams, sizeof(bparams), "key=%s", items[i].browse_key);
            HttpBuffer bbuf = {0};
...
bool player_get_queue_actions(BlusoundPlayer *p, PlayerSource *source, QueueActions *out)
{
    ...
    if (!source->context_menu_key[0]) return false;
    ...
    snprintf(params, sizeof(params), "key=%s", cm_enc);
    HttpBuffer buf = {0};
    if (!player_request(p, "/Browse", params, &buf)) return false;
    ...
    for (int i = 0; i < items_count; i++) {
        ...
        if (!items[i].play_url[0]) continue;
